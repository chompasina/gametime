...
function recordFoodScore(foodsArray, food){
  ...
  totalPointsBar.style = "width:" + (total / 10) + "%";
  totalPointsBar.innerHTML = total + "Health points";
  winPointsBar.style = "width:" + (1000 - (total / 10)) + "%";
  winPointsBar.innerHTML = (1000 - total) + "Needed to win";
  checkGameOver(total);
}
