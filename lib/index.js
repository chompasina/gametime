...
function healthFoodDraw(healthFood){
  console.log(healthFood.type);
  if (healthFood.type === 'beet'){
    imageObj.src = require('../images/beet.png');
  } else if(healthFood.type === 'broccoli') {
    imageObj.src = require('../images/broccoli.png');
  } else if (healthFood.type === 'redPepper') {
    imageObj.src = require('../images/red-pepper.png');
  } else if (healthFood.type === 'redCabbage'){
    imageObj.src = require('../images/red-cabbage.png');
  } else {
    imageObj.src = require('../images/carrot.png');
  }
  context.drawImage(imageObj, healthFood.x, healthFood.y, healthFood.width, healthFood.height);
}
