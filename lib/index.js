...
function beginGame(){
  ...
  // world.trayCollision.check(world.junkFoods, world.trayCollision, reqAnimFrameID);
  // document.getElementById('score-game').innerHTML = "Score: " + world.trayCollision.total;
}
