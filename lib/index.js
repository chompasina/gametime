...
function endGame(){
  if(trayCollision.total >= 600){
    console.log("your score:" + trayCollision.total)
...
function addScore(winningScore){
  console.log("top score: " + scoreBoard.scores[0]);
  console.log("last score already listed: " + Math.min.apply(Math, scoreBoard.scores));
