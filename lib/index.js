...
function foodDraw(food){
  ...
  } else if (food.type === 'artichoke'){
    foodImage.src = require('../images/artichoke.png');
  } else if (food.type === 'banana'){
    foodImage.src = require('../images/banana.png');
  } else if (food.type === 'blueberries'){
    foodImage.src = require('../images/blueberries.png');
  } else if (food.type === 'cherry'){
    foodImage.src = require('../images/cherry.png');
  } else if (food.type === 'cucumber'){
    foodImage.src = require('../images/cucumber.png');
  } else if (food.type === 'eggplant'){
    foodImage.src = require('../images/eggplant.png');
  } else if (food.type === 'grape'){
    foodImage.src = require('../images/grape.png');
  } else if (food.type === 'onion'){
    foodImage.src = require('../images/onion.png');
  } else if (food.type === 'peas'){
    foodImage.src = require('../images/peas.png');
  } else if (food.type === 'strawberry'){
    foodImage.src = require('../images/radish.png');
  } else if (food.type === 'tomato'){
    foodImage.src = require('../images/tomato.png');
  } else if (food.type === 'yellowPepper'){
    foodImage.src = require('../images/yellow_pepper.png');
  } else if (food.type === 'orange'){
    foodImage.src = require('../images/orange.png');
  ...
  } else if (food.type === 'corndog'){
    foodImage.src = require('../images/corndog.png');
  } else if (food.type === 'fried pancakes'){
    foodImage.src = require('../images/pancakes.png');
  } else if (food.type === 'white_bread'){
    foodImage.src = require('../images/white_bread.png');
