...
function healthFoodDraw(healthFood){
  ...
  context.drawImage(healthFoodImage, healthFood.x, healthFood.y, healthFood.width, healthFood.height);
}
...
function junkFoodDraw(junkFood){
  ...
  } else if (junkFood.type === 'friedChicken'){
    junkFoodImage.src = require('../images/fried-chicken.png');
  } else {
    junkFoodImage.src = require('../images/pizza.png');
  }
  context.drawImage(junkFoodImage, junkFood.x, junkFood.y, junkFood.width, junkFood.height);
}
