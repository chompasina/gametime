function RandomHealthFood(){
  var healthFoods = [
    ...
    {"type": "redPepper", "color": "red", "score": "7", 'x': Math.random()*(600 - 30)+15, 'y': 0, 'image': "../images/red-pepper.png"},
    ...
    {"type": "cherry", "color": "red", "score": "7", 'x': Math.random()*(600 - 30)+15, 'y': 0, 'image': "../images/cherry.png"},
    ...
    {"type": "strawberry", "color": "red", "score": "150", 'x': Math.random()*(600 - 30)+15, 'y': 0, 'image': "../images/strawberry.png"},
    ...
    {"type": "carrot", "color": "orange", "score": "200", 'x': Math.random()*(600 - 30)+15, 'y': 0, 'image': "../images/carrot.png"}
  ];
